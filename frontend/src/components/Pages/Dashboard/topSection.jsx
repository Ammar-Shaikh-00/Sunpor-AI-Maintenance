  ...
  return (
    <div className="mb-8">
      ...
      <div className="flex flex-wrap gap-4">
        <div className="min-w-[180px] flex-1 rounded-xl border border-slate-200/80 bg-[#C5C8CF]/95 px-5 py-3 shadow-md backdrop-blur-sm">
        ...
        <div className="min-w-[180px] flex-1 rounded-xl border border-slate-200/80 bg-[#C5C8CF]/95 px-5 py-3 shadow-md backdrop-blur-sm">
          ...
          <div className="text-base capitalize text-blue-700">
